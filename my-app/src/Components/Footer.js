...
const Footer = () => {
  return (
    <div className="bg-[#1E4077] font-thin text-left text-white">
      ...
      <div className="flex flex-col md:items-center md:flex-row justify-between md:w-9/12 mx-auto mt-4 text-sm p-5">
        ...
        <div className="lg:w-[19%] mt-5 flex flex-col">
